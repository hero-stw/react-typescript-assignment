      ...
      featured: [
        {
          name: "Apple",
          href: "#",
          imageSrc: "https://source.unsplash.com/random?iphone",
          imageAlt:
        ...
        },
        {
          name: "Samsung",
          href: "#",
          imageSrc: "https://source.unsplash.com/random?samsung",
          imageAlt:
...
export default function NavBar() {
  ...
  return (
    <div className="bg-white w-full rounded-md mt-[1rem]">
      {/* Mobile menu */}
      ...
      <header className="relative bg-white rounded-md">
        ...
        <nav
          aria-label="Top"
          className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 rounded-md"
        >
          <div className="border-b border-gray-200">
